...
namespace JmdLoader.Controls
{
    public class DarkTreeView : TreeView
    {
        ...
        {
            using (Stream stream = LoadResource($"JmdLoader.Controls.DarkTreeView.Icons.expanded{(white ? "_white" : "")}.png"))
            {
        ...
        {
            using (Stream stream = LoadResource($"JmdLoader.Controls.DarkTreeView.Icons.collapsed{(white ? "_white" : "")}.png"))
            {
                Bitmap bmp = new Bitmap(stream);
                graphics.DrawImage(bmp, range);
                bmp.Dispose();
        ...
        {
            using (Stream stream = LoadResource($"JmdLoader.Controls.DarkTreeView.Icons.{IconName}"))
            {
                Bitmap bmp = new Bitmap(stream);
