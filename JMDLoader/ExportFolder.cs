...
namespace JMDLoader
{
    public partial class ExportFolder : Form
    {
        ...
        public void ExportNowFolder(string TargetPath, bool IncludeSubFolder, JMDFile file)
        {
            this.Show();
            Task task = new Task(() =>
            {
        ...
        private void ExportNowFolder_bg(string outputPath, bool IncludeSubFolder,JMDFile file)
        {
